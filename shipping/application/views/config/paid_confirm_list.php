		...
		<div class="row">
				...
				<div class="filter">
					<form class="form" method="post" action="<?php echo base_url().'config/filter_list' ?>" id="filter_list">
						...
						<div class="form-group">
							...
							<input type="text" name="from_date" class="form-control dpicker" />
						</div>
						<div class="form-group">
							<label class="control-label">
								To Date
							</label>
							<input type="text" name="to_date" class="form-control dpicker" />
						</div>
			...
			<div class="col-md-12">
				<div class="table-responsive">
					<table class="table basic-datatables" id="all_list_pc">
						<thead>
							<th>No</th>
							<th>ID Order</th>
							<th>Email</th>
